...
import { ArticleBlockType, ArticleListView, ArticleSortField } from '@/entities/Article';
...
export const getArticlesPageType = (state: StateSchema) => state.articlesPage?.type || ArticleBlockType.ALL;
